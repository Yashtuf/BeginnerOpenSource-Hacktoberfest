...
document.getElementById(
  "stats"
).innerHTML = `You guys are awesome, we have again passed the GitHub rate limit this hour. <a href="https://github.com/yaswanthteja/BeginnerOpenSource-Hacktoberfest${currentYear}" target="_blank">Here</a> is a link to check out our repo's live stats.`;
